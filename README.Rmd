...
Implementation of text-evaluation metric BLEU [Papineni et al, 2002](https://aclanthology.org/P02-1040.pdf)
...
Compute the BLEU-score on a sample from the (WMT 22 Metrics Shared Task)[https://wmt-metrics-task.github.io/].
